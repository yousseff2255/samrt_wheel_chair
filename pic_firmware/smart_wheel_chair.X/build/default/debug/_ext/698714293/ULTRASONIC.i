...
# 2 "<built-in>" 2
# 1 "../HAL/ULTRASONIC/ULTRASONIC.c" 2
...
# 2 "../HAL/ULTRASONIC/ULTRASONIC.c" 2


# 1 "../HAL/ULTRASONIC/../../SERVICES/STD_TYPES.h" 1
...
# 5 "../HAL/ULTRASONIC/ULTRASONIC.c" 2
# 1 "../HAL/ULTRASONIC/../../SERVICES/BIT_MATH.h" 1
# 6 "../HAL/ULTRASONIC/ULTRASONIC.c" 2
# 1 "../HAL/ULTRASONIC/../../MCAL/TMR0/TMR0_interface.h" 1
...
# 7 "../HAL/ULTRASONIC/ULTRASONIC.c" 2
# 1 "../HAL/ULTRASONIC/../../MCAL/EXTI/EXTI_interface.h" 1
...
void EXTI_ToggleEdge(void);
# 8 "../HAL/ULTRASONIC/ULTRASONIC.c" 2
# 1 "../HAL/ULTRASONIC/ULTRASONIC_interface.h" 1
...
# 9 "../HAL/ULTRASONIC/ULTRASONIC.c" 2
# 1 "../HAL/ULTRASONIC/ULTRASONIC_private.h" 1



# 1 "../HAL/ULTRASONIC/../../MCAL/REGISTERS/PIC16F877A_reg.h" 1
# 5 "../HAL/ULTRASONIC/ULTRASONIC_private.h" 2
# 10 "../HAL/ULTRASONIC/ULTRASONIC.c" 2
# 1 "../HAL/ULTRASONIC/ULTRASONIC_config.h" 1
# 11 "../HAL/ULTRASONIC/ULTRASONIC.c" 2


static volatile u8 Echo_State = 0u;
static volatile u8 Echo_TickCount = 0;
static volatile u8 Echo_Overflow = 0;
static volatile u8 Echo_Ready = 0;
...
# 108 "../HAL/ULTRASONIC/ULTRASONIC.c"
u16 ULTRASONIC_GetDistance(void) {
    u32 total_ticks = 0;
    u16 distance = 0;
    u16 timeout = 60000;
    ...
    ( (PORTD) |= (1U << (5)) );
    _delay((unsigned long)((10)*(10000000UL/4000000.0)));
    ( (PORTD) &= ~(1U << (5)) );


    while (Echo_Ready == 0) {
        _delay((unsigned long)((10)*(10000000UL/4000000.0)));
        if (--timeout == 0) return 400u;
    }


    INTCONbits.GIE = 0;
    u8 ov = Echo_Overflow;
    u8 tck = Echo_TickCount;
    INTCONbits.GIE = 1;

    total_ticks = ((u32)ov * 256UL) + (u32)tck;
    distance = (u16)((float)total_ticks * ((12.8f * 0.0343f) / 2.0f));
