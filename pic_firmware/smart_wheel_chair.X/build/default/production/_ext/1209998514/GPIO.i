...
# 1 "../MCAL/GPIO/../../SERVICES/STD_TYPES.h" 1
...
# 4 "../MCAL/GPIO/../../SERVICES/STD_TYPES.h" 2
...
# 5 "../MCAL/GPIO/GPIO_interface.h" 2
# 31 "../MCAL/GPIO/GPIO_interface.h"
...
# 1 "../MCAL/GPIO/../REGISTERS/PIC16F877A_reg.h" 1
# 5 "../MCAL/GPIO/GPIO_private.h" 2
# 3 "../MCAL/GPIO/GPIO.c" 2
# 1 "../MCAL/GPIO/GPIO_config.h" 1
# 4 "../MCAL/GPIO/GPIO.c" 2

# 1 "../MCAL/GPIO/../../SERVICES/BIT_MATH.h" 1
# 6 "../MCAL/GPIO/GPIO.c" 2
...
u8 GPIO_GetPinValue(u8 Port, u8 Pin)
{
    ...
    {
        case 0:
            Local_Value = ( ((PORTA) >> (Pin)) & 1U );
        break;

        case 1:
            Local_Value = ( ((PORTB) >> (Pin)) & 1U );
        break;

        case 2:
            Local_Value = ( ((PORTC) >> (Pin)) & 1U );
        break;

        case 3:
            Local_Value = ( ((PORTD) >> (Pin)) & 1U );
        break;

        case 4:
            Local_Value = ( ((PORTE) >> (Pin)) & 1U );
        break;
