...
# 46 "../HAL/MAX30102/MAX30102_program.c"
...
MAX30102_Status_t MAX30102_Init(void) {
    uint8_t id = MAX30102_ReadReg(0xFF);
    if (id != 0x15u ) return MAX30102_ERR;

    MAX30102_WriteReg(0x09u, 0x40u);
    _delay((unsigned long)((100)*(10000000UL/4000.0)));
    MAX30102_WriteReg(0x08u, 0x1F);
...
void MAX30102_Update(void) {
    ...
    while (numSamples > 0) {
        ...
        if (ir < 5000UL) {
            ...
            MAX30102_WriteReg(0x04u, 0);
            MAX30102_WriteReg(0x06u, 0);
            return;
        }
        ...
        if (s_result.irAC > 50 && s_lastIrAC <= 50) {
