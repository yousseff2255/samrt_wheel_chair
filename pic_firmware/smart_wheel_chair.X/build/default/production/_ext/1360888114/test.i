...
# 20 "../APP/test.c" 2
# 1 "../APP/../MCAL/I2C/I2C_interface.h" 1
# 11 "../APP/../MCAL/I2C/I2C_interface.h"
...
# 21 "../APP/test.c" 2
# 1 "../APP/../MCAL/UART/UART_interface.h" 1
...
# 22 "../APP/test.c" 2
# 1 "../APP/../HAL/ULTRASONIC/ULTRASONIC_interface.h" 1
...
# 23 "../APP/test.c" 2
# 1 "../APP/../HAL/MPU6050/MPU6050_interface.h" 1
...
# 24 "../APP/test.c" 2
# 1 "../APP/../HAL/MAX30102/MAX30102_interface.h" 1
...
# 25 "../APP/test.c" 2
# 1 "../APP/../HAL/MOTOR/MOTOR_interface.h" 1
...
# 26 "../APP/test.c" 2
# 1 "../APP/../HAL/BUZZER/BUZZER_interface.h" 1
...
static volatile uint8_t g_pi_command = 'F';
...
static void Lcd_Write_Nibble(uint8_t nibble, uint8_t rs) {
    uint8_t data = nibble | rs | 0x08;
    I2C_Start();
    I2C_Write(0x4E);
    I2C_Write(data | 0x04); _delay((unsigned long)((5)*(10000000UL/4000000.0)));
    I2C_Write(data & ~0x04);
    I2C_Stop();
...
static void Lcd_Cmd(uint8_t cmd) {
    ...
    if (cmd == 0x01 || cmd == 0x02) _delay((unsigned long)((2)*(10000000UL/4000.0)));
}

static void Lcd_Char(char c) {
    Lcd_Write_Nibble(c & 0xF0, 0x01);
    Lcd_Write_Nibble((c << 4) & 0xF0, 0x01);
}
...
static void Lcd_Init_Raw(void) {
    _delay((unsigned long)((50)*(10000000UL/4000.0)));
    Lcd_Write_Nibble(0x30, 0); _delay((unsigned long)((5)*(10000000UL/4000.0)));
    Lcd_Write_Nibble(0x30, 0); _delay((unsigned long)((150)*(10000000UL/4000000.0)));
    Lcd_Write_Nibble(0x30, 0); _delay((unsigned long)((150)*(10000000UL/4000000.0)));
    Lcd_Write_Nibble(0x20, 0); _delay((unsigned long)((2)*(10000000UL/4000.0)));
...
void main(void) {
    ...
    while (1) {
        ...
        _delay((unsigned long)((10)*(10000000UL/4000.0)));
    }
}
