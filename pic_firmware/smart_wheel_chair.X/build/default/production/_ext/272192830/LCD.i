...
# 2 "<built-in>" 2
# 1 "../HAL/LCD/LCD.c" 2
# 1 "../HAL/LCD/../../SERVICES/STD_TYPES.h" 1
...
# 4 "../HAL/LCD/../../SERVICES/STD_TYPES.h" 2
...
# 2 "../HAL/LCD/LCD.c" 2
# 1 "../HAL/LCD/../../SERVICES/BIT_MATH.h" 1
# 3 "../HAL/LCD/LCD.c" 2
# 1 "../HAL/LCD/../../MCAL/I2C/I2C_interface.h" 1
# 11 "../HAL/LCD/../../MCAL/I2C/I2C_interface.h"
...
# 6 "../HAL/LCD/LCD.c" 2
# 1 "../HAL/LCD/LCD_private.h" 1
# 7 "../HAL/LCD/LCD.c" 2
# 1 "../HAL/LCD/LCD_config.h" 1
# 8 "../HAL/LCD/LCD.c" 2
# 17 "../HAL/LCD/LCD.c"
static void Lcd_SendNibble(u8 nibble) {
    I2C_Write(nibble | 0x04);
...
static void Lcd_I2C_Write(u8 dat, u8 rs_mode) {
    u8 hi = (dat & 0xF0) | rs_mode | 0x08;
    u8 lo = ((dat << 4) & 0xF0) | rs_mode | 0x08;
...
void Lcd_Init(void) {
    ...
    Lcd_SendNibble(0x30 | 0x08);
    _delay((unsigned long)((5)*(10000000UL/4000.0)));
    Lcd_SendNibble(0x30 | 0x08);
    _delay((unsigned long)((150)*(10000000UL/4000000.0)));
    Lcd_SendNibble(0x30 | 0x08);
    _delay((unsigned long)((150)*(10000000UL/4000000.0)));
    Lcd_SendNibble(0x20 | 0x08);
    _delay((unsigned long)((2)*(10000000UL/4000.0)));
