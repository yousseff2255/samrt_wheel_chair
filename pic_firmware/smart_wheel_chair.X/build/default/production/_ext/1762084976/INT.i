...
# 6 "../MCAL/INT/INT.c" 2
# 1 "../MCAL/INT/../../SERVICES/STD_TYPES.h" 1
...
# 7 "../MCAL/INT/INT.c" 2
# 1 "../MCAL/INT/../../SERVICES/BIT_MATH.h" 1
# 8 "../MCAL/INT/INT.c" 2
# 1 "../MCAL/INT/../TMR0/TMR0_private.h" 1



# 1 "../MCAL/INT/../TMR0/../REGISTERS/PIC16F877A_reg.h" 1
# 5 "../MCAL/INT/../TMR0/TMR0_private.h" 2
# 26 "../MCAL/INT/../TMR0/TMR0_private.h"
extern u8 TMR0_PreloadValue;
# 9 "../MCAL/INT/INT.c" 2
# 1 "../MCAL/INT/../EXTI/EXTI_private.h" 1
# 10 "../MCAL/INT/INT.c" 2
...
# 23 "../MCAL/INT/INT.c"
    if (( ((INTCON) >> (1)) & 1U ) && ( ((INTCON) >> (4)) & 1U )) {
        ( (INTCON) &= ~(1U << (1)) );
        if (EXTI_CallBackFuncP != ((void*)0))
            EXTI_CallBackFuncP();
    }
    ...
    if (( ((INTCON) >> (TMR0IF)) & 1U ) && ( ((INTCON) >> (TMR0IE)) & 1U )) {
        ( (INTCON) &= ~(1U << (TMR0IF)) );
        if (TMR0_CallBackFuncP != ((void*)0))
            TMR0_CallBackFuncP();
    }
}
